...
std::shared_ptr<Blender> Blender::Resolve(Graphics& gfx, bool enBlend, std::optional<float> factor) noexcept
{
...
{
    return GenUID(m_enBlend, m_factors ? m_factors->front() : std::optional<float>{});
}
