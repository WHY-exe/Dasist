...
public:
	...
	void BindAsBuffer(Graphics& gfx, BufferResource* br) noexcept(!IS_DEBUG) override {};
...
{
public:
	DeferredBufferAsShaderInput(Graphics& gfx, UINT width, UINT height, UINT slot = 0);
